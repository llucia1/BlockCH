...
@section('breadcrumb') 
    ...
    <li class="breadcrumb-item active" aria-current="page">{{ trans('app.courses.courses') }}</li>
        ...
        <div class="col-12 grid-margin stretch-card">
            ...
            <div class="card">
                ...
                <div id="table-data" class="card-body">
                    ...
                    <h4 class="card-title">{{ trans('app.listOf') }} {{ trans('app.courses.courses') }}</h4>
                    <p class="card-description float-left">
                        <a href="{{ route('courses.create') }}" class="btn btn-primary btn-fw"><i class="mdi mdi-plus"></i>{{ trans('app.create') }}</a>
                    </p>
                    ...
                    @include('courses::partials/tables/index_table')
