        ...
        <div class="col-12 grid-margin stretch-card">
            ...
            <div class="card">
                ...
                <div id="table-data" class="card-body">
                    ...
                    <p class="card-description float-left"><a href="{{ route('videos.create') }}" class="btn btn-primary btn-fw"><i class="mdi mdi-plus"></i>{{ trans('app.create') }}</a></p>
                    ...
                    @include('webminar::partials.tables.index_table')
