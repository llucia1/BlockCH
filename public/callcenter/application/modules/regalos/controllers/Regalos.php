...
class Regalos  extends MX_Controller
{
    private $nameClass;
    private $icono;
    private $proyecto;
	...
	public function index()
	{
        ...
        $data['getResult'] = $this->doctrine->em->getRepository("Entities\\Regalos")->findAll();
    ...
    public function add()
    {
        ...
        if(isset($_POST['submit']))
        {
            ...
            if ($this->form_validation->run())
            {
                ...
                $reg = new Entities\Regalos;
                //seteamos los datos
                $reg->setValor($this->input->post('nombre'));
                //guardamos //EDITADO
    ...
    public function edit($id)
    {
        ...
        $data['getRow'] = $this->doctrine->em->find("Entities\\Regalos", $id);
        //comprobamos formulario submit
        if(isset($_POST['submit']))
        {
            //validamos los datos
            ...
            if ($this->form_validation->run())
            {
                ...
                $data['getRow']->setValor($this->input->post('nombre'));
                $this->doctrine->em->flush();
            }
    ...
    public function delete($id)
    {
        ...
        $getRow = $this->doctrine->em->getRepository("Entities\\Regalos")->findOneBy(["id" => $id]);
        //eliminamos el item
