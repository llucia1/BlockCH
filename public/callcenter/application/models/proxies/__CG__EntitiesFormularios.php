 ...
 */
class Formularios extends \Entities\Formularios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Formularios' . "\0" . 'id', '' . "\0" . 'Entities\\Formularios' . "\0" . 'name', '' . "\0" . 'Entities\\Formularios' . "\0" . 'campaign'];
        }
