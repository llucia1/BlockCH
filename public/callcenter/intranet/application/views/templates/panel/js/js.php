...
<script type="text/javascript">var rol = "<?= $this->session->userdata('rol') ?>";</script>
...
<script src="<?= base_url('assets/pages/scripts/form-input-mask.min.js') ?>"></script>
...
<script src="<?= base_url('assets/js_private/ajax_actions.js') ?>" type="text/javascript"></script>
<script src="<?= base_url('assets/actions/pages_actions.js') ?>" type="text/javascript"></script>
