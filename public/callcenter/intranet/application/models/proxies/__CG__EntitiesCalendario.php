...
class Calendario extends \Entities\Calendario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Calendario' . "\0" . 'id', '' . "\0" . 'Entities\\Calendario' . "\0" . 'fecha', '' . "\0" . 'Entities\\Calendario' . "\0" . 'year', '' . "\0" . 'Entities\\Calendario' . "\0" . 'month', '' . "\0" . 'Entities\\Calendario' . "\0" . 'day', '' . "\0" . 'Entities\\Calendario' . "\0" . 'hour', '' . "\0" . 'Entities\\Calendario' . "\0" . 'comentario', '' . "\0" . 'Entities\\Calendario' . "\0" . 'estado', '' . "\0" . 'Entities\\Calendario' . "\0" . 'checkit', '' . "\0" . 'Entities\\Calendario' . "\0" . 'idcliente', '' . "\0" . 'Entities\\Calendario' . "\0" . 'idusuario'];
        }
