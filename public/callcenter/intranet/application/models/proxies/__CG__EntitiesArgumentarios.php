 ...
 */
class Argumentarios extends \Entities\Argumentarios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Argumentarios' . "\0" . 'id', '' . "\0" . 'Entities\\Argumentarios' . "\0" . 'title', '' . "\0" . 'Entities\\Argumentarios' . "\0" . 'argumentario', '' . "\0" . 'Entities\\Argumentarios' . "\0" . 'createDate', '' . "\0" . 'Entities\\Argumentarios' . "\0" . 'updateDate', '' . "\0" . 'Entities\\Argumentarios' . "\0" . 'campaign'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Argumentarios $proxy) {
    ...
    public function setArgumentario($argumentario)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setArgumentario', [$argumentario]);

        return parent::setArgumentario($argumentario);
    }
    ...
    public function getArgumentario()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getArgumentario', []);

        return parent::getArgumentario();
    }
