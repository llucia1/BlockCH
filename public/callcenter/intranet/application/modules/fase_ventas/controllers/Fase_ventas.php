...
class Fase_ventas  extends MX_Controller
{
    private $nameClass;
    private $icono;
    private $proyecto;
	...
	public function index()
	{
        ...
        $data['getResult'] = $this->doctrine->em->getRepository("Entities\\Faseventas")->findAll();
    ...
    public function edit($id)
    {
        ...
        $data['getRow'] = $this->doctrine->em->find("Entities\\Faseventas", $id);
        //comprobamos formulario submit
        if(isset($_POST['submit']))
        {
            //validamos los datos
