    ...
    <div class="portlet light profile-sidebar-portlet bordered">
        ...
        <div class="profile-userbuttons">
            ...
            <?php if($getRow->getEstado() == 1): ?>
                ...
                <button data-radio="false" data-id="<?= $getRow->getId() ?>" data-value="0"  data-entity="Usuarios" data-field="estado" type="button" class="btn btn-circle red btn-sm md-boolean">Bloqueado</button>

            <?php else: ?>

                <button data-radio="false" data-id="<?= $getRow->getId() ?>" data-value="1" data-entity="Usuarios" data-field="estado" type="button" class="btn btn-circle green btn-sm md-boolean">Desbloqueado</button>
